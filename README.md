...
Ποιοι παράγοντες επηρεάζουν περισσότερο την απόδοση μιας ομάδας; (πολλαπλή παλινδρόμηση, W/L% ~ ORtg, DRtg, Pace, TS%, 3PAr, 3P%)
Σουτάρουν οι ομάδες διαφορετικά τρίποντα Εντός vs Εκτός έδρας; (t-test, σε επίπεδο αγώνα)
Διαφέρει το 3P% ανάλογα με τη δύναμη του αντιπάλου; (ANOVA, σε επίπεδο αγώνα)
Ευρήματα
Ερώτημα	Αποτέλεσμα
...
Δεδομένα
Επίσημο στατιστικό API του NBA (μέσω `nba_api`), ζωντανά, ανά ζήτηση.
Τεχνολογίες
